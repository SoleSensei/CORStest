...
public class TopSites {
    ...
    protected static final int NUMBER_TO_RETURN = 100000;
    ...
    public static void main(String[] args) throws Exception {
      ...
      TopSites topSites = new TopSites(accessKey, secretKey, countryCode);
        ...
        System.out.println("Response to " + "top-1m" + countryCode + ".xml");
        PrintWriter writer = new PrintWriter("top-1m" + countryCode + ".xml", "UTF-8");
